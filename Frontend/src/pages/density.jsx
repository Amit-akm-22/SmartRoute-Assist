...
console.log("📍 [Dashboard] Using Backend URL:", BACKEND_URL);
...
const Dashboard = () => {
  ...
  const fetchZoneData = async () => {
    try {
      const response = await fetch(`${BACKEND_URL}/zone/density`);
  ...
  const handleZoneScan = async (e) => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/zone/scan`, {
        method: "POST",
